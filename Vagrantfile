...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision :shell, :inline => "cd /tmp && wget https://releases.linaro.org/components/toolchain/binaries/latest-7/aarch64-linux-gnu/gcc-linaro-7.4.1-2019.02-x86_64_aarch64-linux-gnu.tar.xz && tar -xvJf aarch64-linux-gnu/gcc-linaro-7.4.1-2019.02-x86_64_aarch64-linux-gnu.tar.xz && mv gcc-linaro-7.4.1-2019.02-x86_64_aarch64-linux-gnu /usr/lib/gcc/gcc-linaro"
